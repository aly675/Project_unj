      ...
      <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
        ...
        <div class="relative">
          <input
            type="text"
            placeholder="Search"
            class="pl-8 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 appearance-none text-sm w-64 mt-0"
          />
